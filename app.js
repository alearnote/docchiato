...
const datasets = {
  meme: {
    ...
    events: [
      ...
      { id: "m43", text: "漫画家ナガノ氏がゲーム『ポケポケ』に関連した漫画をTwitterに投稿。(「もうさァッ無理だよ ルールわかんないんだからさァッ」のセリフが特に有名)", date: "2024-11-03" },
      { id: "m44", text: "マクドナルドが期間限定のイメージキャラクター「いまだけダブチ食べ美」を発表", date: "2024-10-22" },
      { id: "m45", text: "深淵「深淵を覗く時、深淵もまたこちらを覗いているのだ」ちっちゃい深淵「のだ」(Twitter投稿日)", date: "2024-06-17" },
      { id: "m46", text: "テレビ番組『ネプリーグ』にて、「ぼうにあ○る」の誤答が放送", date: "2019-07-08" },
      { id: "m47", text: "れすぽん氏の楽曲『45秒』ニコニコ動画に投稿。「45秒で何ができる?」のフレーズが有名", date: "2013-05-29" },
      ...
      { id: "m58", text: "Twitterに「ギャルによる怒りの6段活用」が投稿(この中で3段階目にあたる「激おこぷんぷん丸」が特に流行するように)", date: "2013-03-02" },
      ...
      { id: "m111", text: "映画『カメラを止めるな!』全国公開が順次開始(先行公開の翌年)", date: "2018-06-23" },
      ...
      { id: "m124", text: "マカオとジョマ構文が流行し、「待ちなさーい」「マカオとジョマ」がTwitterでトレンド入り", date: "2023-05-27" },
      ...
      { id: "m210", text: "文字に似た特定の記号が書いてあるサイコロを振り＂特殊な役＂を出すことを目指すゲーム『NKODICE』がSteamで発売", date: "2021-05-29" },
      ...
      { id: "m217", text: "弌誠氏によるMV『モエチャッカファイア』がYoutubeに投稿", date: "2024-07-19" },
      ...
      { id: "m225", text: "ゲーム『天穂のサクナヒメ』発売日", date: "2020-11-12" },
      { id: "m225", text: "ゲーム『ライザのアトリエ 〜常闇の女王と秘密の隠れ家〜』発売日(Nintendo Switch/PS4)", date: "2019-09-26" },
