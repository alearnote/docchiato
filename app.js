...
const datasets = {
  meme: {
    ...
    events: [
      ...
      { id: "m187", text: "Twitterで岩手県広報がいわて応援ポケモンとして「イシツブテ」が任命されたと発表。足が透過したイシツブテの着ぐるみの画像が話題に", date: "2019-05-14" },
      ...
      { id: "m225", text: "ゲーム『ライザのアトリエ 〜常闇の女王と秘密の隠れ家〜』発売日(Nintendo Switch/PlayStation4)", date: "2019-09-26" },
