...
const datasets = {
  meme: {
    ...
    events: [
      ...
      { id: "m45", text: "Twitterに「深淵『深淵を覗く時、深淵もまたこちらを覗いているのだ』ちっちゃい深淵『のだ』のネタツイが投稿", date: "2024-06-17" },
      ...
      { id: "m230", text: "Youtuberちょんまげ小僧のチャンネル登録者が100万人を達成(メンバーの一人であるひき肉くんの自己紹介「ひき肉です‼︎」が流行)", date: "2023-08-21" },
    ],
  },
};
